        ...
        lessons: [
          { 
            ...
            quizzes: [
              ...
              { question: "What is the purpose of the <nav> element?", options: ["To define a navigation section", "To create a sidebar", "To link to external CSS", "To define the footer"], answer: 0, explanation: "The <nav> element is intended for major blocks of navigation links." },
              { question: "Which tag is used to define an independent, self-contained article?", options: ["<section>", "<div>", "<article>", "<aside>"], answer: 2, explanation: "The <article> element represents a self-contained composition in a document, page, application, or site." },
              { question: "What is the correct tag for a line break?", options: ["<lb>", "<break>", "<br>", "<hr>"], answer: 2, explanation: "The <br> tag is used to insert a single line break." },
              { question: "Which element is used to group related content in a sidebar?", options: ["<aside>", "<section>", "<div>", "<nav>"], answer: 0, explanation: "The <aside> element defines some content aside from the content it is placed in (like a sidebar)." },
              { question: "What does the <footer> element typically contain?", options: ["The main title", "Navigation links", "Author information and copyright", "The main content"], answer: 2, explanation: "A <footer> element typically contains the author of the document, copyright information, contact information, etc." },
              { question: "Which attribute is used to provide alternative text for an image?", options: ["title", "src", "alt", "longdesc"], answer: 2, explanation: "The alt attribute provides alternative information for an image if a user for some reason cannot view it." },
              { question: "Which tag is used to define a footer for a document or section?", options: ["<bottom>", "<footer>", "<end>", "<section>"], answer: 1, explanation: "The <footer> element defines a footer for a document or section." }
            ]
          },
          { 
            id: "l2", 
            ...
            quizzes: [
              ...
              { question: "What does 'justify-content' do in Flexbox?", options: ["Aligns items vertically", "Aligns items horizontally", "Distributes space between items along the main axis", "Sets the flex direction"], answer: 2, explanation: "justify-content defines the alignment along the main axis." },
              { question: "Which property controls the alignment of items along the cross axis?", options: ["justify-content", "align-items", "flex-wrap", "align-content"], answer: 1, explanation: "align-items defines the default behavior for how flex items are laid out along the cross axis." },
              { question: "How do you make a flex container's items wrap to the next line?", options: ["flex-wrap: wrap", "display: block", "flex-direction: column", "float: left"], answer: 0, explanation: "The flex-wrap property allows flex items to wrap onto multiple lines." },
              { question: "What is the default value of 'flex-direction'?", options: ["row", "column", "row-reverse", "column-reverse"], answer: 0, explanation: "The default direction is row (left to right)." },
              { question: "In CSS Grid, what property is used to define columns?", options: ["grid-template-columns", "grid-column-gap", "grid-auto-columns", "grid-columns"], answer: 0, explanation: "grid-template-columns specifies the number and size of columns in a grid layout." },
              { question: "Which unit is unique to CSS Grid for flexible sizing?", options: ["px", "em", "fr", "vh"], answer: 2, explanation: "The fr unit represents a fraction of the free space in the grid container." },
              { question: "How do you center an item both horizontally and vertically in a flex container?", options: ["justify-content: center; align-items: center;", "text-align: center;", "margin: auto;", "display: block;"], answer: 0, explanation: "A combination of justify-content: center and align-items: center will perfectly center flex items." },
              { question: "What property defines the space between grid rows and columns?", options: ["grid-margin", "gap", "padding", "border-spacing"], answer: 1, explanation: "The gap (or grid-gap) property defines the size of the guters between rows and columns." },
              { question: "Which property allows a grid item to span multiple columns?", options: ["grid-column", "grid-area", "span-column", "grid-span"], answer: 0, explanation: "grid-column (or grid-column-start/end) allows items to span multiple columns." }
            ]
          }
        ],
      },
